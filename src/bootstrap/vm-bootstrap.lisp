;;;; vm-bootstrap.lisp
;;;; Version bootstrap de la machine virtuelle MIPS (Phase 10)
;;;; Adaptée pour bootstrap - messages debug retirés
...
(defun vm-malloc (vm size)
  ...
  (let ((addr *heap-pointer*))
    ...
    ;; Debug retiré dans version bootstrap
    addr))
...
(defun init-memory-layout (vm)
  ...
  ;; Messages debug retirés dans version bootstrap
  nil)
